...
import EditarFuncionario from './components/Admin-CadastroUserPage/AlterarUsuarioPage/EditarFuncionario.jsx';
...
function App() {
  ...
  return (
    ...
    <Routes>
        ...
        <Route path="/updatefuncionario" element={<EditarFuncionario isAuthenticated={isAuthenticated} />} />
      </Routes>
    </div>
  );
}
