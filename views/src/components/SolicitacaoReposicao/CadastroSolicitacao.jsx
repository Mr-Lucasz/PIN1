        ...
        <form className="container-cadastro-produto">
          <div className='container-form'>
            <div className='inputs-field-form'>
              ...
              <div className='categoria-field-form'>
                <div className='label-categoria'>
                  <label htmlFor="categoria">TOTEM</label>
                </div>
                <div className='input-categoria'>
                  <select value={id_totem}
                    required
                    onChange={(e) =>
              ...
              <div className='categoria-field-form'>
                <div className='label-categoria'>
                  <label htmlFor="categoria">ITEM DO ESTOQUE</label>
                </div>
                <div className='input-categoria'>
                  <select value={id_itemestoque}
                    required
                    onChange={(e) =>
              ...
              <div className='categoria-field-form'>
                <div className='label-categoria'>
                  <label htmlFor="categoria">STATUS REPOSICAO</label>
                </div>
                <div className='input-categoria'>
                  <select value={status_reposicao}
                    required
                    onChange={(e) =>
              ...
              <div className='produto-field-form'>
                <div className='label-produto'>
                  <label htmlFor="produto">OBSERVAÇÃO:</label>
                </div>
            ...
            <div className='area-button-confirmar'>
              ...
              <input type="submit" value="CONFIRMAR" className="confirmar-button"  onClick={(e) =>
                    createSolicitacao(e)}/>
            </div>
          </div>
        </form>
